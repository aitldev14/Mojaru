...
function first_image(){
  ...
  document.getElementById("2").style.cssText = `opacity: 0.5; height: 65px; width: 65px;`;
  document.getElementById("3").style.cssText = `opacity: 0.5; height: 65px; width: 65px;`;
...
function second_image(){
  ...
  document.getElementById("1").style.cssText = `opacity: 0.5; height: 65px; width: 65px;`;
  document.getElementById("3").style.cssText = 'opacity: 0.5; height: 65px; width: 65px;';
